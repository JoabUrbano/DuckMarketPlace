...
extern void DuckMarketPlace__addProduct(DuckMarketPlace__IDPRODUTO ii, DuckMarketPlace__NOMEPRODUTO nn, DuckMarketPlace__IDUSUARIO uu, int32_t qq, int32_t pp);
...
extern void DuckMarketPlace__payDebt(DuckMarketPlace__IDUSUARIO uu);
extern void DuckMarketPlace__payDebtWithCredit(DuckMarketPlace__IDUSUARIO uu, int32_t cc);
...
extern void DuckMarketPlace__preAddProduct(DuckMarketPlace__IDPRODUTO ii, DuckMarketPlace__NOMEPRODUTO nn, DuckMarketPlace__IDUSUARIO uu, int32_t qq, int32_t pp, bool *oo);
...
extern void DuckMarketPlace__prePayDebt(DuckMarketPlace__IDUSUARIO uu, bool *oo);
extern void DuckMarketPlace__prePayDebtWithCredit(DuckMarketPlace__IDUSUARIO uu, int32_t cc, bool *oo);
